...
function Sell(props) {
    ...
    <div className="bg-slate-900 flex flex-col items-center justify-center h-screen w-screen">
        ...
        <nav className="flex items-start justify-between gap-5 self-start max-md:max-w-full max-md:flex-wrap">
            ...
            <a href="Buy.jsx" className="text-white text-center text-xl self-center my-auto">
            BUY
            </a>
        ...
        <div className="bg-blue-800 flex flex-col items-center mt-4 px-20 py-12 rounded-2xl">
        <h1 className="text-white text-4xl font-bold mb-4 ml-8 ">SELL</h1>
        <h3 className="text-white text-2xl font-bold mb-8 ml-8 ">Rate:  1KWh   =  $ 0.43BTC</h3>
        <img
            loading="lazy"
        ...
        />
        <h3 className="text-white text-2xl font-bold mb-2 ml-8 ">Price = 43 BTC</h3>
        <button className="text-white text-center text-xl whitespace-nowrap justify-center items-center bg-cyan-800 w-[212px] mt-2 px-16 py-6 rounded-[100px]">
            SELL
        </button>
        </div>
